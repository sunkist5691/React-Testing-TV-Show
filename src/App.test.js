...
// Anything below 'await' is '.then'
// whatever below of 'await', it will not perform until Promise object resolved.
...
// if 'dropdown' is another library that is coming, 
// using data-id is not working, so use findByText to select the text
