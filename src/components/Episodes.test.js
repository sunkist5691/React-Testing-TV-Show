import React from 'react' // to render into Virutal DOM
...
test('re-render with Episodes', () => {
   ...
   // act (re-render the component with the data)
...
/* FLOW */
// first. rendering gets empty array.
// second, rerendered when the data get fetched.
// third, check to see if the elements had founded (use 'getAllByTestId', which will return array)
// fourth, 

/* TIPS */
// Any props that is passed in components are REQUIRED in order to successfully test!
// To get a data, we need to visit 'response' tab at 'network' tab, and convert that JSON into Javascript
// and utilize that data like 'line 8'
// getAllByTestId retunrs an array when it matches more than 1 match.
// If we use getAllBy and didn't get any return, we will get an error, which we can use
// queryByAll just for not getting any error, and just return a empty array.
